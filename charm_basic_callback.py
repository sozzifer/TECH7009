...
app.layout = html.Div(
    children=[
        ...
        html.Div(id="sentence-output",
                 children=["This is the color I love"], style={}),
        dcc.RadioItems(id='my-radioitem', value="black",
...
def update_my_graph(val_chosen):
    if len(val_chosen) > 0:
        ...
        fig = px.pie(dff, values="ytd_return",
                     names="fund_extended_name", title="Year-to-Date Returns")
