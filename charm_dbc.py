...
app.layout = html.Div([
    dbc.Row(
        dbc.Col(
            html.H3("Our Beautiful App Layout"),
            width={"size": 6, "offset": 3},
        )
    ),
    dbc.Row([
        dbc.Col(
            dcc.Dropdown(id="c_dropdown",
                         placeholder="last dropdown",
        ...
        dbc.Col(
            dcc.Dropdown(id="b_dropdown",
                         placeholder="middle dropdown",
                         options=[{"label": "Option A", "value": "optA"},
                                  {"label": "Option B", "value": "optB"}]),
